/**
 * YourName_Chapter9_Assignment1.java
 * COP 2250 -- Chapter 9, Assignment 1
 *
 * Replace "YourName" in the filename and class name with your actual name.
 * Replace "YI" in Rectangle_YI with your actual first and last initials.
 *
 * Compile: javac YourName_Chapter9_Assignment1.java
 * Run:     java YourName_Chapter9_Assignment1
 */

// ============================================================
// Rectangle_YI class -- NO public keyword on this class
// ============================================================
class Rectangle_YI {
    ...
    // Rectangle_YI(double width, double height) {
    //     this.width = width;
    //     this.height = height;
    // }
...
// ============================================================
public class YourName_Chapter9_Assignment1 {

    public static void main(String[] args) {

        // STEP 6: Create rectangle 1 with width=4 and height=40

        // Rectangle_YI r1 = new Rectangle_YI(4, 40);
        ...
        // Rectangle_YI r2 = new Rectangle_YI(3.5, 35.9);
